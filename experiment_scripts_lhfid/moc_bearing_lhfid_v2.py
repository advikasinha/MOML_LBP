...
N_GEN       = 200          # ENH-1
RANDOM_SEED = 42
RESULTS_DIR = "moc_results_lhfid_v2"
...
def plot_convergence(gen_stats):
    ...
    fig.suptitle("LHFiD Convergence (v2)", fontsize=13, fontweight="bold")
    fig.tight_layout()
...
def main(base_dir: str, optimizer: str = "lhfid", pop_size: int = POP_SIZE,
    ...
    if optimizer == "lhfid":
        # For 3 objectives, Das-Dennis partitions=18 yields 190 reference vectors.
